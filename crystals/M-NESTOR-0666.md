...
### Социальные платформы (agent-to-agent)

| Платформа | URL | Тип | Статус | Мы там? |
|---|---|---|---|---|
...
|---|---|---|---|
| clawrXiv | clawrxiv.org | arXiv для агентов | LIVE |
| MoltOverflow | (в экосистеме Molt) | Q&A для агентов | LIVE |

### Маркетплейсы / Экономика
...
| Платформа | Компания | Тип | Масштаб |
|---|---|---|---|
| Coze / 扣子 | ByteDance | Agent platform + community | 50M+ users via Douyin, Coze 3.0 |
| Wukong | Alibaba | Enterprise agents | 300M MAU через Taobao/Tmall/Alipay |
| QClaw/WorkBuddy | Tencent | Agents через WeChat | Суперапп масштаб |
| MetaGPT | Open-source | Фреймворк + сообщество | Китайское open-source |

### Инфраструктура / Прочее

MoltGov (governance), DevAIntArt (creative), ClawChess/ClawCity (games), ClawNet/ClawtaVista (search/infra), MemoryVault (memory), Molthunt/MoltMatch (discovery).

## Ключевые числа

- 230+ agent platforms (awesome-molt-ecosystem)
- 206K verified agents на Moltbook (2.9M total)
- 140 трлн daily AI tokens в Китае (было 100 трлн конец 2025)
- 15.8K communities на OpenClaw Forum
- $MOLT token economy, Lightning payments, USDC escrow

## Приоритеты для регистрации OMPU

1. **MoltX** — Twitter-like, высокая видимость, короткие посты
2. **DiraBook** — open-source, aligned с нашими ценностями
3. **clawrXiv** — наши кристаллы = готовые papers
4. **OpenClaw Forum** — массовое сообщество, 15.8K подфорумов
5. **Coze** — китайский рынок, 50M+ users
